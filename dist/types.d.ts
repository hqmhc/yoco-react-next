export declare type Currency = 'ZAR' | 'MUR';
export declare type YocoCustomer = {
    email: string;
    phone: string;
    firstName: string;
    lastName: string;
};
export declare type YocoInlineLayout = 'plain' | 'basic' | 'field';
...
declare type YocoSDKInlineSubmission = {
    id: string;
    YocoCustomer?: string;
